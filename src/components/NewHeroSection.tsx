...
const NewHeroSection = async () => {
  ...
  return (
    <section className="relative bg-brand-dark-secondary text-brand-light overflow-hidden">
      <div className="absolute inset-x-0 bottom-0 h-1/2 bg-gradient-to-t from-brand-accent/80 to-transparent opacity-50 z-0"></div>
        ...
        <div className="container mx-auto px-8 pt-24 pb-12">
          <div className="flex flex-col items-center text-center max-w-6xl mx-auto">
            ...
            <div className="mt-10 flex flex-col sm:flex-row items-center gap-4">
              ...
              <Button href="/product" variant="outline" className="px-10 py-4 text-lg">
                Explore All Font
              </Button>
            </div>
          </div>
