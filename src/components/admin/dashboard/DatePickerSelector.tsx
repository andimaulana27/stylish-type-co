// src/components/admin/dashboard/DatePickerSelector.tsx
'use client';
...
const DatePickerSelector = ({ selectedPreset, setSelectedPreset, dateRange, setDateRange, isLoading, displayLabel }: DatePickerSelectorProps) => {
