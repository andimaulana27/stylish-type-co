...
const LicenseCard = ({ license }: { license: LicenseDetail }) => {
  return (
    <div className="bg-brand-darkest border border-brand-accent/50 rounded-lg p-5 h-full flex flex-col relative overflow-hidden group transition-all duration-300 hover:border-brand-accent/50 hover:-translate-y-1">
